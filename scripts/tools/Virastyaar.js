...
(function (name, global, definition) {
...
}('Virastyaar', this, function () {
  function Virastyaar(text, options) {
    if (!(this instanceof Virastyaar)) {
      return new Virastyaar(text, options);
    }
  ...
  Virastyaar.prototype.parseOptions = function (options) {
    var defaults = {
      normalize_eol: true,
      fix_dashes: true,
      fix_three_dots: true,
  ...
  Virastyaar.prototype.cleanup = function (text, options) {
